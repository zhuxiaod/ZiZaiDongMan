...
-(UIView *)searchSuggestionView:(UITableView *)searchSuggestionView viewForHeaderInSection:(NSInteger)section{
    if([self.dataSource respondsToSelector:@selector((searchSuggestionView:viewForHeaderInSection:))]){
        return [self.dataSource searchSuggestionView:searchSuggestionView viewForHeaderInSection:section];
    }
    return nil;
}

- (CGFloat)searchSuggestionView:(UITableView *)searchSuggestionView heightForHeaderInSection:(NSInteger)section{
    if([self.dataSource respondsToSelector:@selector(searchSuggestionView:heightForHeaderInSection:)]){
        return [self.dataSource searchSuggestionView:searchSuggestionView heightForHeaderInSection:section];
    }
    return 44;
}

-(UIView *)searchSuggestionView:(UITableView *)searchSuggestionView viewForFooterInSection:(NSInteger)section{
    if([self.dataSource respondsToSelector:@selector((searchSuggestionView:viewForFooterInSection:))]){
        return [self.dataSource searchSuggestionView:searchSuggestionView viewForFooterInSection:section];
    }
    return nil;
}

- (CGFloat)searchSuggestionView:(UITableView *)searchSuggestionView heightForFooterInSection:(NSInteger)section{
    if([self.dataSource respondsToSelector:@selector(searchSuggestionView:heightForFooterInSection:)]){
        return [self.dataSource searchSuggestionView:searchSuggestionView heightForFooterInSection:section];
    }
    return 44;
}
