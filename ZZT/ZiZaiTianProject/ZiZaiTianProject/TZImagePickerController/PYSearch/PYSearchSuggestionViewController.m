...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    if([self.dataSource respondsToSelector:@selector(searchSuggestionView:viewForHeaderInSection:)]){
        return [self.dataSource searchSuggestionView:tableView viewForHeaderInSection:section];
    }
    return nil;
}
...
-(CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section{
    if([self.dataSource respondsToSelector:@selector(searchSuggestionView:heightForHeaderInSection:)]){
        return [self.dataSource searchSuggestionView:tableView heightForHeaderInSection:section];
    }
    return 44;
}
...
-(UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section{
    if([self.dataSource respondsToSelector:@selector(searchSuggestionView:viewForFooterInSection:)]){
        return [self.dataSource searchSuggestionView:tableView viewForFooterInSection:section];
    }
    return nil;
}
...
-(CGFloat)tableView:(UITableView *)tableView heightForFooterInSection:(NSInteger)section{
    if([self.dataSource respondsToSelector:@selector(searchSuggestionView:heightForFooterInSection:)]){
        return [self.dataSource searchSuggestionView:tableView heightForFooterInSection:section];
    }
    return 44;
}
