...
//            NSData *imageData = animatedImageView.animatedImage.data;
            NSData *imageData = UIImagePNGRepresentation(animatedImageView.animatedImage);
//            NSData *imageData = animatedImageView.animatedImage;
            if (!imageData) {
...
- (NSURL *)highQualityImageURLForIndex:(NSInteger)index
{
    if (_photoBrowserStyle == HZPhotoBrowserStyleDefault) {
        ...
        return [NSURL URLWithString:[NSString stringWithFormat:@"%@",_imageArray[index]]];
    }
    return nil;
}
