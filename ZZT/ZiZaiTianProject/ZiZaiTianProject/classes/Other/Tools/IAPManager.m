...
static NSString * const transactionID = @"transactionID_key";
...
-(void)saveReceipt:(SKPaymentTransaction *)transaction{
    ...
    self.userId = [NSString stringWithFormat:@"%ld",[Utilities GetNSUserDefaults].id];
...
//        UserInfo *user = [Utilities GetNSUserDefaults];
        NSDictionary *dict = @{
                               @"TransactionID":[dic objectForKey:transactionID],//订单号
                               @"Payload":[dic objectForKey:receiptKey],//票据
                               @"userId": [dic objectForKey:userIdKey]
                               };
